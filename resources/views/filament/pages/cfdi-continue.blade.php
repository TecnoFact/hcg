...
<x-filament-panels::page>
    ...
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md"
         x-data="{ cfdiArchivo: @entangle('cfdiArchivo'), subido: @entangle('subido'), sellado: @entangle('sellado'), timbrado: @entangle('timbrado'), depositado: @entangle('depositado'), xmlPath: @entangle('xmlPath'), estado: @entangle('estado'), pdf_file: @entangle('pdf_file') }">
            ...
            <div class="relative w-full">
                <form wire:submit.prevent="subirXml">
                    <x-filament::button
                        ...
                        style="background-color: #01A4C1; color: white;"
                        class="transition-all duration-300 w-full opacity-50 cursor-not-allowed"
                    >
                        <div class="flex items-center w-full flex-col justify-center" wire:loading.remove>
                            ...
                            <span x-text="subido ? 'Subido ✓' : 'Subir'" class="ml-1"></span>
                        </div>
                ...
                <div class="absolute text-center w-full mt-1 -bottom-2 left-1/2 transform text-xs text-gray-500 dark:text-gray-400">
                    Paso 1
                </div>
            </div>
                ...
                <form wire:submit.prevent="sellarXml">
                    ...
                    >
                        <div class="flex items-center w-full flex-col justify-center" wire:loading.remove>
                            ...
                            <span x-text="sellado ? 'Sellado ✓' : 'Sellar'" class="ml-1"></span>
                        </div>
                ...
                <form wire:submit.prevent="timbrarXml">
                    ...
                    >
                        <div class="flex items-center w-full flex-col justify-center" wire:loading.remove>
                            ...
                            <span x-text="timbrado ? 'Timbrado ✓' : 'Timbrar'" class="ml-1"></span>
                        </div>
                ...
                <form wire:submit.prevent="publicacion">
                    ...
                    >
                        <div class="flex items-center w-full flex-col justify-center" wire:loading.remove>
                            ...
                            <span x-text="depositado ? 'Depositado ✓' : 'Depositar'" class="ml-1"></span>
                        </div>
